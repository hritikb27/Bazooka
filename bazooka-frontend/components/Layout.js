...
export default function Layout({children}) {
    ...
    return (
        <div id='layout' className="flex w-full h-screen justify-between">
            <aside className="h-full bg-black bg-opacity-80 bg-clip-padding w-[20%] flex flex-col justify-between top-0 fixed" style={{backdropFilter:'blur(10px)'}}>
                <ul className="mt-[10rem] font-semibold text-xl text-white">
